...
TEMPLATE_ID = "b6797f3437db4c818256560e4f68143cb99c7bc9"
APP_URL = "http://localhost:8080"
SAMPLE_NAME = "EmbeddedSignerConsumerServices"
ROLE_NAME = "Recipient 1"


class IndexController(SampleController):
    def handle_get(self, query_params: dict[str, str]) -> Response:
        if query_params.get("page") == "finish":
    ...
    def _create_invite_and_return_signing_link(self, client) -> str:
        ...
        redirect = f"{APP_URL}/samples/{SAMPLE_NAME}?page=finish&document_id={document_id}"
