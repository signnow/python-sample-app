...
ACTION_TEMPLATE_ID = "c78e902aa6834af6ba92e8a6f92b603108e1bbbb"
APP_URL = "http://localhost:8080"
SAMPLE_NAME = "MedicalInsuranceClaimForm"
...
class IndexController(SampleController):
    ...
    def handle_post(self, form_data: dict[str, Any]) -> Response:
        ...
        if action == "create-embedded-invite":
            ...
            link = self._create_embedded_invite_and_return_signing_link(client, ACTION_TEMPLATE_ID, full_name, email)
    ...
    def _create_embedded_invite_and_return_signing_link(self, client, template_id: str, full_name: str, email: str) -> str:
        ...
        self._prefill_fields(client, document_id, {"Name": full_name, "Email": email})

        signer_email = settings.sn_signer_email
